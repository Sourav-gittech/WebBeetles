...
import { emailVerify } from "../../../redux/slice/authSlice/authSlice";
                            ...
                            <div className="flex flex-col items-center mt-4">
                                {disabled ? (
                                    <p className="text-white text-sm">
                                        Resend OTP in{" "}
                                        <span className={counter < 10 ? "text-red-400" : ""}>
                                    ...
                                    <button type="button" onClick={handleResend} className="text-white text-sm font-medium hover:text-blue-300">
                                        Resend OTP
                                    </button>
                                )}
                            </div>
